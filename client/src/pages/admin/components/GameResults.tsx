...
export function GameResults({ results, questionIndex, autoAdvanceLeft, onNextQuestion, onEndGame }: Props) {
  return (
    <div className="main-content">
      <div className="gc-header mb-4">
        ...
        <div className="flex gap-2 gc-results-actions">
          ...
          <button onClick={onNextQuestion} className="btn btn-primary btn-lg" style={{ position: 'relative', minWidth: 180 }}>
